            ...
            >
                ...
                {images.map((src, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`absolute left-1/2 top-1/2 w-[150px] md:w-[200px] h-[150px] md:h-[200px] -translate-x-1/2 -translate-y-1/2 transition-all duration-500 ease-in-out ${isActive ? 'scale-125 z-10' : 'scale-100 z-0'
                                }`}
                            style={{
                                transform: `translate(-50%, -50%) rotate(${angle}deg) translateY(-180px) md:translateY(-250px) rotate(-${angle}deg)`,
                            }}
                        >
                            <Image
                                src={src}
