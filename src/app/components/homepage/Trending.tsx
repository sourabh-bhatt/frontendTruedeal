...
const TrendingOffers = () => {
    ...
    const offers = [
        ...
        },
        {
            ...
            discount: 15,
            amenities: ["Stay", "Transfers", "Activities"],
        ...
        },
        {
            ...
            image: "/Assets/DestinationsImage/switzerland.jpg",
            discount: 15,
            amenities: ["Stay", "Transfers", "Sightseeing"],
        ...
        },
        {
            ...
            image: "/Assets/DestinationsImage/vietnam.jpg",
            discount: 15,
            amenities: ["Stay", "Transfers", "Guided Tours"],
            destination: "vietnam"
        }
    ];
                ...
                {offers.map((offer, index) => (
                    <div key={index} className="bg-white rounded-3xl overflow-hidden shadow-lg">
                        ...
                        <div>
                            ...
                            <button
                                onClick={() => router.push(`/trending/${offer.destination}`)}
