                ...
                <div className="md:hidden">
                    <div className="overflow-x-auto -mx-4 px-4">
                        <div className="flex gap-6 min-w-min">
                            {packages.map((package_: SriLankaPackage) => (
                                <div 
                                    key={package_.id}
                ...
                <div className="mt-6">
                    ...
                    <div className="md:hidden flex justify-center items-center gap-2">
                        ...
                        <span className="text-sm text-gray-500">
                            {currentPage + 1} / {windowWidth >= 768 ? totalPages : mobileTotalPages}
                        </span>
                        <Button 
                            onClick={handleNext} 
                            disabled={currentPage === (windowWidth >= 768 ? totalPages - 1 : mobileTotalPages - 1)}
                            variant="outline"
                            className="rounded-full w-8 h-8 p-0"
                        >
