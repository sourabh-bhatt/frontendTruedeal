...
export default function SriLankaPage({ params }: PageProps) {
    const { id } = use(params);
    
    const package_ = Object.values(sriLankaData).find(pkg => pkg.id === id);
